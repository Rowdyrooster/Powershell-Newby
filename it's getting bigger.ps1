...
pause}
"14"{New-ADUser -Name Test -AccountPassword (Read-Host -AsSecureString "AccountPassword") -Manager "jmontgomery" -EmailAddress "Test@contoso.com" -DisplayName "Test" -GivenName Joshua -Surname Montgomery -Description IT -Office AuburnOps -ho -UserPrincipalName "Test" -CannotChangePassword $False -ChangePasswordAtLogon $True -Title Clerck -Department IT -Company UCB -Enabled $True 
pause}
}
